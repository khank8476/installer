...
use Kamrankhandev\Installer\Requests\InstallConfigRequest;
use Kamrankhandev\Installer\Requests\InstallDatabaseRequest;
...
class InstallerController
{
    ...
    public function requirements()
    {
        ...
        return view('installer::requirements', ['results' => $results]);
    }
    ...
    public function permissions()
    {
        ...
        return view('installer::permissions', ['results' => $results]);
    }
    ...
    public function storeDatabase(InstallDatabaseRequest $request)
    {
        ...
        // run route:cache and route:trans:cache
    ...
    private function subscribeNewsletter(Request $request)
    {
        ...
        try {
            $httpClient->request(
                'POST',
                'https://kamrankhan_dev.render.com/newsletter',
                [
                    'form_params' => [
